...
CREATE TABLE playoff_config (
	playoff_config_id	INTEGER NOT NULL AUTO_INCREMENT,
	tournament_id 		INTEGER NOT NULL,
	category 			ENUM('MIXTO','FEMENIL','VARONIL') NOT NULL,
	stage				VARCHAR(10) NOT NULL,
	is_locked			BOOLEAN DEFAULT FALSE,
	CONSTRAINT PK_playoff_config PRIMARY KEY (playoff_config_id),
	CONSTRAINT FK_playoff_config_tournament FOREIGN KEY (tournament_id) REFERENCES tournaments (tournament_id)
);

CREATE TABLE playoff_teams (
	playoff_team_id INTEGER NOT NULL AUTO_INCREMENT,
	tournament_id 	INTEGER NOT NULL,
	category 		ENUM('MIXTO','FEMENIL','VARONIL') NOT NULL,
	name 			VARCHAR(20) NOT NULL,
	...
	points_won 		INTEGER NOT NULL DEFAULT 0,
	points_lost 	INTEGER NOT NULL DEFAULT 0,
	CONSTRAINT PK_playoff_teams PRIMARY KEY (playoff_team_id),
	CONSTRAINT FK_playoff_teams_tournament FOREIGN KEY (tournament_id) REFERENCES tournaments (tournament_id)
);

CREATE TABLE playoff_games (
	playoff_game_id INTEGER NOT NULL AUTO_INCREMENT,
	tournament_id 	INTEGER NOT NULL,
	category 		ENUM('MIXTO','FEMENIL','VARONIL') NOT NULL,
	stage	 		VARCHAR(10) NOT NULL,
	place 			INTEGER NOT NULL DEFAULT 0,
	game_date  		DATETIME,
	game_place 		VARCHAR(10),
	...
	CONSTRAINT PK_playoff_games PRIMARY KEY (playoff_game_id),
	CONSTRAINT FK_playoff_games_tournament FOREIGN KEY (tournament_id) REFERENCES tournaments (tournament_id),
	CONSTRAINT FK_playoff_games_team_1 FOREIGN KEY (team_1) REFERENCES playoff_teams(playoff_team_id),
	CONSTRAINT FK_playoff_games_team_2 FOREIGN KEY (team_2) REFERENCES playoff_teams(playoff_team_id),
	CONSTRAINT UC_playoff_games_match UNIQUE (tournament_id,category,stage,game_date,team_1,team_2)
);