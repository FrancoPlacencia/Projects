...
public class TeamController {
    ...
    // READ
    @GetMapping("/teams")
    public ResponseEntity<List<TeamDTO>> getTeams(@RequestParam Integer id, @RequestParam String category, @RequestParam String stage) {
        return teamService.getTeams(id, category, stage);
    }
    ...
    public ResponseEntity<Map<String, List<TeamOptionsDTO>>> getTeamsOptions(@RequestParam Integer id, @RequestParam String stage) {
        return teamService.getTeamOptions(id, stage);
    }
