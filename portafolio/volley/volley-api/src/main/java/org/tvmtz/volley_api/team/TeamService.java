...
public interface TeamService {
    ...
    ResponseEntity<List<TeamDTO>> getTeams(Integer tournamentId, String category, String stage);
    ...
    ResponseEntity<Map<String, List<TeamOptionsDTO>>> getTeamOptions(Integer tournamentId, String stage);
