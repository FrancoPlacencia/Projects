...
public class TeamServiceImpl implements TeamService {
    ...
    @Override
    public ResponseEntity<Map<String, List<TeamOptionsDTO>>> getTeamOptions(Integer tournamentId, String stage) {
        List<Team> teams = teamRepository.findByTournamentAndStage(tournamentId, stage).orElse(new ArrayList<>());
        if (teams.isEmpty()) {
